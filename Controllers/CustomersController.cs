...
namespace Clinic_MVC.Controllers
{
    public class CustomersController : Controller
    {
        ...
        public CustomersController(Clinic_MVCContext context)
        {
            _context = context;
        }
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,Customer_Name,Address,Customer_Age,Joining_Date")] Customer customer)
        {
            if (id != customer.Id)
            {
                return NotFound();
